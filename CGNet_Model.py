...
class CGNet(nn.Module):
    def __init__(self, device=None):
        ...
        self.TDec_x2   = DecoderTransformer_x3(input_transform='1', in_index=[0, 1, 2, 3, 4], align_corners=True, 
                    in_channels = [128, 256, 512, 512], embedding_dim= 64, output_nc=1, 
                    decoder_softmax = None, device=device)
